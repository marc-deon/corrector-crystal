...
bool Rect_Overlap(Rectangle rect1, Rectangle rect2){
...
// 1 for right, -1 for left. If rectangles don't overlap, return 0.
// TODO(#12): This *technically* has a built in bias towards moving left, which
// could result in unwanted behavior if both rectangles overlap perfectly.
